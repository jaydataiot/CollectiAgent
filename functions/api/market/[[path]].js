const UPSTREAM_ORIGIN = "https://bay-trends.replit.app";
...
async function proxyToUpstream({ request, params }) {
  ...
  try {
    ...
    responseHeaders.set("X-Collecti-Upstream", "market");
    ...
    console.error(JSON.stringify({ event: "market_proxy_failure", message: String(error) }));
    return Response.json(
      { error: "CollectiMarketAnalyzer is temporarily unavailable." },
